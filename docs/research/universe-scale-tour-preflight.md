...
| **N5 — M1/GPU-ms calibration** (unticketed; integrated-gpu-targeting.md §5, Steps 3–4) | **DONE 2026-07-27** — ran on the M1 (integrated-gpu-targeting.md §5.4). Universe `toGalaxy` GPU-ms: high 8.2/41.6/47.1 (over budget), medium 2.2/8.7/10.7 (60 fps), low 1.0/6.0/10.2. | **CLOSED** — validates TASK-072's `medium` boot floor; no retune needed |
